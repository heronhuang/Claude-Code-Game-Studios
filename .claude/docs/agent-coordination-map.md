...
```
  ...
  Engine Specialists (use the SET matching your engine):
    ...
    cocos-specialist   -- Cocos Creator 3.x lead: components, bundles, events, scenes
      cocos-typescript-specialist  -- TypeScript/JS: components, decorators, lifecycle, patterns
      cocos-shader-specialist      -- Shaders: Effect (.effect), materials, particles
      cocos-native-specialist      -- Native: JSB, Android/iOS SDK bridges, platform plugins
```
